                                ...
                                >
                                    ...
                                    <div className={`group flex flex-col gap-1.5 ${message.sender === "user" ? "items-end" : "items-start"}`}>
                                        <div className={`relative px-4 py-3 rounded-2xl text-sm leading-relaxed shadow-sm transition-all hover:shadow-md ${message.sender === "ai"
                                            ...
                                            {message.text ? (
                                                <div className={`prose prose-sm max-w-none ${message.sender === "ai" ? "prose-slate" : "prose-invert"}`}>
                                                    <ReactMarkdown
                                                        ...
                                                        components={{
                                                            ...
                                                            th: ({ node, ...props }) => (
                                                                <th className="px-4 py-3 bg-slate-100 text-left font-semibold text-slate-700 border-b border-slate-200 whitespace-nowrap" {...props} />
                                                            ),
                                                            td: ({ node, ...props }) => (
                                                                <td className="px-4 py-2 border-b border-slate-100 text-slate-600 align-top break-words" {...props} />
                                                            ),
                                                            p: ({ node, ...props }) => <p className="mb-2 last:mb-0" {...props} />,
                                                            ul: ({ node, ...props }) => <ul className="list-disc pl-5 mb-3 space-y-1" {...props} />,
                                                            ol: ({ node, ...props }) => <ol className="list-decimal pl-5 mb-3 space-y-1" {...props} />,
                                                            li: ({ node, ...props }) => <li className="marker:text-slate-400" {...props} />,
                                                            a: ({ node, ...props }) => <a className="text-[#6051E2] hover:underline break-all" {...props} />,
                                                ...
                                                <span className="italic opacity-70">Processing attachment...</span>
                                            )}
